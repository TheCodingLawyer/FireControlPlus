    ...
    public static void onCommand(CommandSender s) {
        ...
        if (ConfigUtils.getInfoLanguage().equalsIgnoreCase("French")) {
            ...
            if (commandLines != null && commandLines.length > 0) {
                ...
                s.sendMessage(
                        "\u00A77- \u00A7b/report <joueur> (raison) \u00A77: \u00A7eSignale un joueur."
                );
                s.sendMessage(
                        "\u00A77- \u00A7b/reports reload \u00A77: \u00A7eRecharge le plugin."
                );
                s.sendMessage(
                        "\u00A77- \u00A7b/reports \u00A77: \u00A7eAffiche l'ensemble des signalements."
                );
                s.sendMessage(
            ...
            if (commandLines != null && commandLines.length > 0) {
                ...
                s.sendMessage(
                        "\u00A77- \u00A7b/report <player> (reason) \u00A77: \u00A7eReports a player."
                );
                s.sendMessage(
                        "\u00A77- \u00A7b/reports reload \u00A77: \u00A7eReloads the plugin."
                );
                s.sendMessage("\u00A77- \u00A7b/reports \u00A77: \u00A7eDisplays all reports.");
                s.sendMessage(
                        "\u00A77- \u00A7b/reports <report id> \u00A77: \u00A7eDisplays a specific report."
                );
                s.sendMessage(
                        "\u00A77- \u00A7b/reports user <player> \u00A77: \u00A7eManages data of an user."
                );
                s.sendMessage(
                ...
                s.sendMessage(
                        "\u00A77- \u00A7b/reports archiveall \u00A77: \u00A7eArchives all done reports."
                );
                s.sendMessage(
                        "\u00A77- \u00A7b/reports archives \u00A77: \u00A7eDisplays all archived reports."
                );
                s.sendMessage(
