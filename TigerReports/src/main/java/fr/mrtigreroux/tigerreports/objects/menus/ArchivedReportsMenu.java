...
public class ArchivedReportsMenu extends ReportsPageMenu {
    ...
    public ArchivedReportsMenu(User u, int page, ReportsManager rm, Database db,
        ...
        super(
                ...
                ReportsCharacteristics.ARCHIVED_REPORTS,
                rm,
                db,
                taskScheduler,
                um
    ...
    public void onUpdate(Inventory inv) {
        ...
        rm.fillInventoryWithReportsPage(
                inv,
                reportsPage,
                Message.REPORT_RESTORE_ACTION.get() + (u.hasPermission(Permission.STAFF_DELETE) ? Message.REPORT_DELETE_ACTION.get() : ""), false, "", vm, bm
        );
    }
                            ...
                            public void onResultReceived(Report r) {
                                if (r == null) {
                                    ...
                                    click == ClickType.DROP
                                            && u.hasPermission(Permission.STAFF_DELETE)
                                ) {
