...
public class ProcessMenu extends ReportManagerMenu {
    ...
    public ProcessMenu(User u, int reportId, ReportsManager rm, Database db,
    ...
    public Inventory onOpen() {
        Inventory inv =
                getInventory(Message.PROCESS_TITLE.get().replace("_Report_", r.getName()), false);
