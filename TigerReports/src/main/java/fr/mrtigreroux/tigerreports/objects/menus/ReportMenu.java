...
public class ReportMenu extends ReportManagerMenu implements User.UserListener {
    ...
    public ReportMenu(User u, int reportId, ReportsManager rm, Database db,
    ...
    public Inventory onOpen() {
        ...
        Inventory inv =
                getInventory(Message.REPORT_TITLE.get().replace("_Report_", r.getName()), true);
                ...
                MenuItem.PUNISH_ABUSE.clone()
                        .details(
                                Message.PUNISH_ABUSE_DETAILS.get()
                                        ...
                                        .replace(
                                                "_Time_",
                                                DatetimeUtils.convertToSentence(
        ...
        inv.setItem(
                26,
                MenuItem.DATA.getWithDetails(
                        r.implementData(
                                Message.DATA_DETAILS.get(),
                                u.hasPermission(Permission.STAFF_ADVANCED),
                                vm,
                                bm
                        )
                )
    ...
    private void implementParticipantsSkull(Inventory inv) {
        boolean stackedReport = r.isStackedReport();
        for (Report.ParticipantType type : new Report.ParticipantType[] {
                Report.ParticipantType.REPORTER, Report.ParticipantType.REPORTED
        }) {
            ...
            for (Statistic stat : Statistic.values()) {
                ...
                String statDisplayedValue = statValue != null
    ...
    public void onClick(ItemStack item, int slot, ClickType click) {
        switch (slot) {
            ...
            case 23:
                ...
                Report.ParticipantType targetType = slot == 21
                        ? Report.ParticipantType.REPORTER
            ...
            case 26:
                ...
                break;
            case 36:
                u.openConfirmationMenu(
                        r,
                        ConfirmationMenu.Action.DELETE,
                        rm,
                        db,
                        taskScheduler,
                        vm,
            ...
            default:
                ...
                switch (slot) {
                    ...
                    case 30:
                    case 31:
                        StatusDetails sd = Report.StatusDetails
                                .from(Arrays.asList(Status.values()).get(slot - 29), u);
                    ...
                    case 33:
                        if (u.canArchive(r)) {
                            u.openConfirmationMenu(
                                    r,
                                    ConfirmationMenu.Action.ARCHIVE,
                                    rm,
                                    db,
                                    taskScheduler,
                                    vm,
    ...
    public void onStatisticsChange(User u) {
        ...
        if (inv != null) {
            ...
            LOGGER.info(
                    () -> this + ": onStatisticsChanged(" + u.getName()
                            + "): open inventoy = null, calls update()"
            );
