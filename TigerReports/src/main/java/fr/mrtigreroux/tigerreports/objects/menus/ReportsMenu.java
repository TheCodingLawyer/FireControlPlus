...
public class ReportsMenu extends ReportsPageMenu {
    ...
    public ReportsMenu(User u, int page, ReportsManager rm, Database db,
        ...
        super(
                ...
                page,
                Permission.STAFF,
                ReportsCharacteristics.CURRENT_REPORTS,
                rm,
                db,
                taskScheduler,
                um
    ...
    public Inventory onOpen() {
        ...
        if (u.hasPermission(Permission.STAFF_ARCHIVE)) {
            inv.setItem(
                    8,
                    MenuItem.ARCHIVED_REPORTS.getWithDetails(Message.ARCHIVED_REPORTS_DETAILS.get())
            );
        }
                ...
                rm.getReportByIdAsynchronously(
                        ...
                        (r) -> {
                            if (
                                ...
                                click == ClickType.DROP && u.hasPermission(Permission.STAFF_DELETE)
                            ) {
                                u.openConfirmationMenu(
                                        r,
