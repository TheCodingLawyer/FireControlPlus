...
repositories {
    ...
    // Added to resolve BanManager and Spigot artifacts
    mavenCentral()
...
dependencies {
    ...
    // Local TigerReports API (place jar under WebEnhancer/libs)
    compileOnly(files(rootProject.file("libs/TigerReports.jar")))
}

// Ensure plugin.yml from common resources is included and expanded
sourceSets {
    main {
        resources {
