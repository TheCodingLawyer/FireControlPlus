...
import me.confuser.banmanager.webenhancer.bukkit.listeners.TigerReportsBridgeListener;
...
//    getServer().getScheduler().runTaskTimerAsynchronously(this, syncRunner, 10L, 10L);
  ...
  public void setupListeners() {
    ...
    // Bridge TigerReports -> BanManager reports
    registerEvent(new TigerReportsBridgeListener(me.confuser.banmanager.common.BanManagerPlugin.getInstance()));
  }
