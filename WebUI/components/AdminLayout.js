...
import { MdOutlineGroups, MdOutlineNotifications, MdLogout, MdSettings, MdWebhook } from 'react-icons/md'
                ...
                <div className='h-full bg-primary-900 flex flex-col'>
                  <div className='pt-3 ml-4'>
                    <div className='flex w-full items-center justify-between'>
                      <Link href='/' passHref className='mx-2' title='Dashboard'>
                        <Image src={(process.env.BASE_PATH || '') + '/images/banmanager-icon.png'} alt='Dashboard' width='40' height='40' priority />
                      </Link>
