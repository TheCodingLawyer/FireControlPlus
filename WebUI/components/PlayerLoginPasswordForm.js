  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className='mx-auto w-full'>
      <div className='flex flex-col relative w-full'>
        ...
        />
        {showForgotPassword && (
          <div className='-mt-3 mb-3 text-gray-300'>
            <Link href='/forgotten-password' className='hover:underline'>Forgot password</Link>
            {' '}or{' '}
            <Link href='/account/register' className='hover:underline'>create account</Link>
          </div>
        )}
