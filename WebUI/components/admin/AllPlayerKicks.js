...
export default function AllPlayerKicks () {
    ...
    <div>
      ...
      >
        <div className='flex items-center'>
          <p className='mr-6 text-xl font-bold '>All Kicks ({total})</p>
      ...
      <div className='relative'>
        ...
        {data?.listPlayerPunishmentRecords?.total > 0 && rows.map((row, i) => (
          <AdminPunishmentCard key={i} type='kick' punishment={row} serverId={tableState.serverId} onDeleted={onDeleted} />
        ))}
      </div>
