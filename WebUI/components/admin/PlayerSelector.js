...
import BedrockIcon from '../player/BedrockIcon'
      ...
      ? data.searchPlayers.map(result => ({
          label: (
            <div className='flex items-center'>
              ...
              />
              <span className='ml-3 block font-normal truncate flex items-center'>
                <span>{result.name}</span>
                <BedrockIcon name={result.name} sizeClass='h-4 w-4' />
              </span>
            </div>
          ),
          value: result.id
  ...
  return (
    <div className='flex items-center'>
      ...
      <span className='ml-3 block font-normal truncate flex items-center'>
        ...
        <BedrockIcon name={player.name} sizeClass='h-4 w-4' />
      </span>
    </div>
  )
}
