...
import me.confuser.banmanager.bukkit.redis.RedisKickSubscriber;
...
public class BMBukkitPlugin extends JavaPlugin {
  ...
  public void onEnable() {
    ...
    // Initialize integrated AdminGUI
    try {
      adminGui = new me.confuser.banmanager.bukkit.admingui.AdminGuiBootstrap(this);
      adminGui.enable();
    } catch (Throwable t) {
    ...
    try {
      redisKickSubscriber = new RedisKickSubscriber(this);
  ...
  public void setupRunnables() {
    ...
    setupAsyncRunnable(100L, new CommandQueueListener(this)); // Run every 5 seconds
