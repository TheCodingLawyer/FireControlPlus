...
public class Settings {
	...
	// Player selector mode (e.g., "actions" to open Actions after selecting a player)
	public static HashMap<UUID, String> player_selector_mode = new HashMap<>();

	//Date Format
	public static SimpleDateFormat date_format = new SimpleDateFormat(AdminGuiIntegration.getInstance().getConf().getString("date_format", "yyyy-MM-dd HH:mm:ss"));
