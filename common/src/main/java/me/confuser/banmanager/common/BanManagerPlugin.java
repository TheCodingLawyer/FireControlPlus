...
public class BanManagerPlugin {
  ...
  @Getter
  private PlayerChatHistoryStorage playerChatHistoryStorage;
  @Getter
  ...
  private void disableDatabaseLogging() {
    // Use literal to avoid triggering LocalLog class initialization before the property is set
    System.setProperty("ormlite.logger.level", "WARNING");
  }
  ...
  public void setupStorage() throws SQLException {
    ...
    playerChatHistoryStorage = new PlayerChatHistoryStorage(this);
  ...
  public CommonCommand[] getCommands() {
    return new CommonCommand[]{
        ...
        new AdminCommandSpyCommand(this),
        new BanCommand(this),
